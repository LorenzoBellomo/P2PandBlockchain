...
\begin{itemize}
	...
	\item \emph{node_modules and src}: Folders related to node and the front-end part. The \emph{src} folder contains some \emph{.css} files (bootstrap) in order to improve the clarity of the web page. 
